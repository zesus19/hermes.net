...
namespace Arch.CMessaging.Client.Impl.Consumer
{
    public class ConfigUtil
    {
        ...
        public ConsumerFlag ConsumerRunAs
        {
            get 
            {
                ConsumerFlag type = ConsumerFlag.Both;
                var typeStr = CentralConfig.GetValue("cmessaging_consumer_flag", "Both");
                if (!Enum.TryParse<ConsumerFlag>(typeStr, out type)) type = ConsumerFlag.Both;
                return type;
            }
        }
