...
using Arch.CMessaging.Client.Core.Ioc.Extensions.Annotation;
...
namespace Arch.CMessaging.Client.Core.Ioc
{
    ...
    public class VenusContainer : IVenusContainer
    {
        ...
        {
            container.AssemblyScanner = new Arch.CMessaging.Client.Core.Ioc.Extensions.Annotation.AssemblyScanner(serviceTypeExtractor);
